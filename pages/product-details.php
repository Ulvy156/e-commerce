    ...
    <section id="product-details">
        <article class="details">
            ...
            <div class="product-content">
                ...
                <div class="add-to-cart">
                    ...
                    <a href="cart.php?action=add&id=<?= (int)$row['product_id']; ?>&qty=1"><button type="button">ADD TO
                            CART</button></a>
                </div>
        ...
        ?>
                <article class="related-product">
                    <img src="<?= htmlspecialchars($row_cat['product_image']); ?>"
                        alt="<?= htmlspecialchars($row_cat['product_name']); ?>">
                    <?php include "../Components/stars.php"; ?>
                    <p><?= htmlspecialchars($row_cat['product_name']); ?></p>
                    <p><?= htmlspecialchars($row_cat['product_price']); ?>$</p>
                    <a href="cart.php?action=add&id=<?= (int)$row_cat['product_id']; ?>&qty=1"><button
                            type="button">Shop Now</button></a>
                </article>
                <?php
                endwhile;
            } else {
